// Based on https://testbit.eu/~timj/blogstuff/simplesignal.cc
#ifndef NARF_SIGNAL_H
#define NARF_SIGNAL_H
 ...
 */
template <typename SignalSignature, class Collector = _Signal::CollectorDefault<typename std::function<SignalSignature>::result_type> >
struct Signal /*final*/ :
    _Signal::ProtoSignal<SignalSignature, Collector>
{
  typedef _Signal::ProtoSignal<SignalSignature, Collector> ProtoSignal;
